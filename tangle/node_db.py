...
def generate_database(node_items, scene):
    ...
    for node_item in node_items:
        try:
            ...
            node_dict = {
                "name": node_item.file_name_no_ext,
                "module": node_item.folder_name,
                "inputs": [
                    socket.socket_type.name
                    for socket in temp_node.get_all_input_sockets()
                ],
            }
    ...
    Logger().info(f"Saved NODE_INFO_DB - {Paths.NODE_INFO_DB}")
